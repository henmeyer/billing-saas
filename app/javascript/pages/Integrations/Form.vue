  ...
  <AppLayout>
    <div class="page-header">
      <div class="flex items-center gap-3">
        ...
        <h2 class="page-title">{{ integration.id ? "Editar" : "Nova" }} integração</h2>
      </div>
    </div>
    ...
    <div class="max-w-2xl space-y-6">
      <div class="card">
        ...
        <div class="card-body space-y-4">
          <div>
            ...
            />
            <p v-if="errors.name" class="form-error">{{ errors.name.join(", ") }}</p>
          </div>
          <div>
            ...
            />
            <p v-if="errors.url" class="form-error">{{ errors.url.join(", ") }}</p>
          </div>
          <div>
      ...
      <div class="card">
        <div class="card-header">
          ...
          <p class="text-xs text-gray-500 mt-0.5">Selecione os eventos que esta integração recebe</p>
        </div>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <p class="text-xs text-gray-500 mt-0.5">Quais tipos de licença esta integração usa</p>
        </div>
        <div class="card-body">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <p class="text-xs text-gray-500 mt-0.5">Quais tipos de crédito esta integração usa</p>
        </div>
        <div class="card-body">
      ...
      <div class="flex gap-3 justify-end">
        ...
        <button @click="submit" :disabled="form.processing" class="btn-primary">
          {{ form.processing ? "Salvando..." : integration.id ? "Salvar" : "Criar integração" }}
        </button>
      </div>
    </div>
  </AppLayout>
...
const submit = () => {
  const url = props.integration.id ? `/integrations/${props.integration.id}` : "/integrations";
